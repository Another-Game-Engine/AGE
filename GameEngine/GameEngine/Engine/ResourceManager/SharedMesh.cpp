...
bool	SharedMesh::load(std::string const &path)
{
	...
	std::cout << "nombre de octet dans le buffer de geometry : " << obj.getSizeAttrib() << std::endl;
	std::cout << "nombre de octet dans le buffer de indices : " << obj.getSizeIndices() << std::endl;
