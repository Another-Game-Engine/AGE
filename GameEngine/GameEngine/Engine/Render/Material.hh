...
namespace gl
{
	...
	DECL_MATERIAL(Texture_diffuse, int, Ratio_diffuse, TEXTURE_DIFFUSE);
	...
	DECL_MATERIAL(Texture_specular, int, Ratio_specular, TEXTURE_SPECULAR);
	...
	DECL_MATERIAL(Texture_ambiant, int, Ratio_ambiant, TEXTURE_AMBIENT);
	...
	DECL_MATERIAL(Texture_emissive, int, Ratio_emissive, TEXTURE_EMISSIVE);
