...
private:
    ...
    void loadMaterialTextures(FbxSurfaceMaterial* fbxMaterial, gameplay::Material* material);

    void loadMaterialFileTexture(FbxFileTexture* fileTexture, gameplay::Material* material);

    void loadMaterialUniforms(FbxSurfaceMaterial* fbxMaterial, gameplay::Material* material);
     ...
     */
    gameplay::Material* createMaterial(const std::string& name, FbxSurfaceMaterial* fbxMaterial, Node* node);
     ...
     */
    gameplay::Material* getBaseMaterial(const char* id);
     ...
     */
    gameplay::Material* findBaseMaterial(gameplay::Material* material);
     ...
     */
    gameplay::Material* createBaseMaterial(const std::string& baseMaterialName, gameplay::Material* childMaterial);
...
private:
     ...
     */
    std::map<std::string, gameplay::Material*> _baseMaterials;
