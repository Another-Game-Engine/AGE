#ifndef		__SECOND_SCENE_HPP__
#define		__SECOND_SCENE_HPP__
...
class SecondScene : public AScene
{
public:
	SecondScene(Engine &engine)
		: AScene(engine)
	{}

	virtual ~SecondScene(void)
	{}
